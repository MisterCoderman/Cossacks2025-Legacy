...
void GP_System::ShowGP(int x, int y, int FileIndex, int SprIndex, byte Nation)
{
	...
	do
	{
		...
		case 2: // transparent 1/4
			if (SprIndex >= 4096)
				GP_ShowMaskedMultiPalTPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, trans4);
			else
				GP_ShowMaskedMultiPalTPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, trans4);
			break;
		case 3: // transparent 1/2
			if (SprIndex >= 4096)
				GP_ShowMaskedMultiPalTPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, trans8);
			else
				GP_ShowMaskedMultiPalTPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, trans8);
			break;
		case 4: // transparent 3/4
			if (SprIndex >= 4096)
				GP_ShowMaskedMultiPalPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, trans4);
			else
				GP_ShowMaskedMultiPalPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, trans4);
			break;
		case 5: // Shadow
			switch (imt)
			{
		...
		case 39:
			...
			case 1: // white
				if (SprIndex < 4096)
					GP_ShowMaskedMultiPalPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, Bright + startTrans);
				else
					GP_ShowMaskedMultiPalPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, fog);
				break;
			case 2: // red
				if (SprIndex < 4096)
					GP_ShowMaskedMultiPalPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, yfog + startTrans);
				else
					GP_ShowMaskedMultiPalPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, yfog);
				break;
			case 3:
				if (SprIndex < 4096)
					GP_ShowMaskedMultiPalPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, Optional1 + startTrans);
				else
					GP_ShowMaskedMultiPalPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, Optional1);
				break;
			case 4:
				if (SprIndex < 4096)
					GP_ShowMaskedMultiPalPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, Optional2 + startTrans);
				else
					GP_ShowMaskedMultiPalPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, Optional2);
				break;
			case 5:
				if (SprIndex < 4096)
					GP_ShowMaskedMultiPalPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, Optional3);
				else
					GP_ShowMaskedMultiPalPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, Optional3);
				break;
			case 6:
				break;
			default:
				if (SprIndex < 4096)
					GP_ShowMaskedMultiPalPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, fog + 1024);
				else
					GP_ShowMaskedMultiPalPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, fog + 1024);
				break;
			}
			break;
		case 41:
			if (SprIndex >= 4096)
				GP_ShowMaskedPictInv(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, NULL);
			else
				GP_ShowMaskedPict(x, y, lpGPCUR, ((byte*)lpGPCUR) + CDOffs, NULL);
			break;
		case 43:
		case 44:
		case 42:
